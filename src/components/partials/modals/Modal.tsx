...
const Modal = (props: ICustomModal) => {
    ...
    const cbc = () => {
        ...
        let result: string = `modal-backdrop fixed top-0 w-full h-[100vh] left-0 z-[5000] overflow-hidden overflow-y-auto transition-all flex items-center justify-center`;
...

                                {
                                    ...
                                    <div className="modal-header flex items-center">
                                        ...
                                        <IconButton
                                            ...
                                            className="ml-auto bg-pag-100 bgh-par-200 parh-700"
                                            icon={{
                                                type: 'polio',
                                                name: 'cancel',
                                                size: 16,
