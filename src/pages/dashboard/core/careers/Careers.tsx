                                            ...
                                            careers.data.map((career: Career, index) =>
                                                <Fragment key={career._id}>
                                                    <tr className="table-row">
                                                        <CellData fontSize={13} className="wp-15" render={helper.formatDate(career.createdAt, 'basic')} />
                                                        <CellData fontSize={13} render={helper.capitalizeWord(career.name)} />
                                                        <CellData fontSize={13} render={helper.capitalizeWord(career.label)} />
                                                        <CellData fontSize={13} className="ui-upcase" render={career.code} />
                                                        <CellData fontSize={13} className="ui-upcase ui-text-center" render={career.fields.length} />
                                                        <CellData fontSize={13} className="ui-upcase ui-text-center" render={career.skills.length} />
                                                        <CellData fontSize={13} className="" status={{ enable: true, type: 'enabled', value: career.isEnabled }} render={<></>} />
