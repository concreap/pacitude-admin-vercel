...
const IndustryDetailsPage = () => {
  ...
  const [form, setForm] = useState<{ action: FormActionType, industryId: string }>({ action: 'edit-resource', industryId: '' })
    ...
    if (!file || (file && !file.base64)) {
      ...
      if (response.error === false && response.status === 200) {
        ...
        resourceContext.setToast({
          ...resourceContext.toast,
          show: true,
          message: `Industry picture uploaded successfully`
        });
        ...
        <div className="halve left-halve">
          ...
          <div>
            ...
            <div className={`avatar rg ui-full-bg bg-center ${loading ? 'disabled-light' : ''}`}>
              ...
              <span className="font-hostgro-bold pab-900 fs-20 ui-upcase">{helper.getInitials(`${coreContext.industry.name || '-------'}`)}</span>
            ...
            <div className="font-hostgro fs-14 pag-500 mrgb0 ui-capitalize d-flex align-items-center">
              {
                coreContext.loading ?
                  ...
                  :
                  <>
                    <span className='fs-14 font-hostgro'>{coreContext.industry.code || '--------'} </span>
                    <Icon
                      type='feather'
                      name='copy'
                      clickable={true}
        ...
        <div className="row">
          ...
          <div className='col-xl-4 col-lg-6 col-md-6 col-12'>
            ...
            <div className="mrgb1 lg-mrgb md-mrgb ">
              <span className='fs-14 color-black-neutral pdr'>Industry Name:</span>

              {
                coreContext.loading ?
                  <Placeholder height='17px' width="160px" radius={'10px'} bgColor='#eceaf1' animate={true} />
                  : <span className='font-hostgro fs-14 pag-500'> {coreContext.industry.name || '------'} </span>
              }
            ...
            <div className="mrgb0">
...

              {
                coreContext.loading ?
                  <Placeholder height='17px' width="160px" radius={'10px'} bgColor='#eceaf1' animate={true} />
                  :
                  <span className='font-hostgro fs-14 font-hostgro fs-14 pag-500 ui-capitalize'> {coreContext.industry.label || '-------'} </span>
              }
          ...
          <div className='col-xl-4 col-lg-6 col-md-6 col-12  mrgb0 lg-mrgb1-mid md-mrgb1'>
            <div className="mrgb1  lg-mrgb md-mrgb">
...

              {
                coreContext.loading ?
                  <Placeholder height='17px' width="160px" radius={'10px'} bgColor='#eceaf1' animate={true} />
                  : <span className='font-hostgro fs-14 pag-500'> {coreContext.industry?.careers?.length} </span>
              }
            ...
            <div className="mrgb0 ">
...

              {
                coreContext.loading ?
                  <Placeholder height='17px' width="160px" radius={'10px'} bgColor='#eceaf1' animate={true} />
                  : <span className='font-hostgro fs-14 pag-500'> {coreContext.industry.code || '-------'} </span>
              }
