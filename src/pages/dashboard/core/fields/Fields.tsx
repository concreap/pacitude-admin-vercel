                                            ...
                                            fields.data.map((field: Field, index) =>
                                                <Fragment key={field._id}>
                                                    <tr className="table-row">
                                                        <CellData fontSize={13} className="wp-15" render={helper.formatDate(field.createdAt, 'basic')} />
                                                        <CellData fontSize={13} render={helper.capitalizeWord(field.name)} />
                                                        <CellData fontSize={13} render={helper.capitalizeWord(field.label)} />
                                                        <CellData fontSize={13} className="ui-upcase" render={field.code} />
                                                        <CellData fontSize={13} className="ui-upcase wp-15 ui-text-center" render={field.skills.length} />
                                                        <CellData fontSize={13} className="" status={{ enable: true, type: 'enabled', value: field.isEnabled }} render={<></>} />
