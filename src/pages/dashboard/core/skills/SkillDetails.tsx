...
const SkillDetailsPage = () => {
    ...
    const [form, setForm] = useState<{ action: FormActionType, skillId: string }>({ action: 'edit-resource', skillId: '' })
        ...
        <>
                ...
                <div className="halve left-halve">
                    ...
                    <div>
                        ...
                        <div className={`avatar rg ui-full-bg bg-center ${loading ? 'disabled-light' : ''}`}>
                            ...
                            <span className="font-hostgro-bold pab-900 fs-20 ui-upcase">{helper.getInitials(`${coreContext.skill.name || '-------'}`)}</span>
                        ...
                        <div className="font-hostgro fs-14 pag-500 mrgb0 ui-capitalize d-flex align-items-center">
                            {
                                coreContext.loading ?
                                    ...
                                    :
                                    <>
                                        <span className='fs-14 font-hostgro'>{coreContext.skill.code || '--------'} </span>
                                        <Icon
                                            type='feather'
                                            name='copy'
                                            clickable={true}
                                            size={15}
                                            onClick={(e) => copyText(e, coreContext.skill.code)}
            ...
            <div className="details-block">
                ...
                <div className="row">
                    ...
                    <div className='col-xl-4 col-lg-6 col-md-6 col-12'>
                        ...
                        <div className="mrgb1 lg-mrgb md-mrgb ">
...

                            {
                                coreContext.loading ?
                                    <Placeholder height='17px' width="160px" radius={'10px'} bgColor='#eceaf1' animate={true} />
                                    : <span className='font-hostgro fs-14 pag-500'> {coreContext.skill.name || '------'} </span>
                            }
                        ...
                        <div className="mrgb0">
...

                            {
                                coreContext.loading ?
                                    <Placeholder height='17px' width="160px" radius={'10px'} bgColor='#eceaf1' animate={true} />
                                    :
                                    <span className='font-hostgro fs-14 font-hostgro fs-14 pag-500 ui-capitalize'> {coreContext.skill.label || '-------'} </span>
                            }
                    ...
                    <div className='col-xl-4 col-lg-6 col-md-6 col-12  mrgb0 lg-mrgb1-mid md-mrgb1'>
                        <div className="mrgb1  lg-mrgb md-mrgb">
...

                            {
                                coreContext.loading ?
                                    <Placeholder height='17px' width="160px" radius={'10px'} bgColor='#eceaf1' animate={true} />
                                    : <span className='font-hostgro fs-14 pag-500'> {coreContext.skill.fields?.length || 0} </span>
                            }
                        ...
                        <div className="mrgb0 ">
...

                            {
                                coreContext.loading ?
                                    <Placeholder height='17px' width="160px" radius={'10px'} bgColor='#eceaf1' animate={true} />
                                    : <span className='font-hostgro fs-14 pag-500'> {coreContext.skill.code || '-------'} </span>
                            }
                    ...
                    <div className='col-xl-4 col-lg-6 col-md-6 col-12  mrgb0 lg-mrgb1-mid md-mrgb1'>
                        <div className="mrgb1  lg-mrgb md-mrgb">
                            <span className='font-hostgro fs-14 color-black-neutral pdr'>Questions:</span>

                            {
                                coreContext.loading ?
                                    <Placeholder height='17px' width="160px" radius={'10px'} bgColor='#eceaf1' animate={true} />
                                    : <span className='font-hostgro fs-14 pag-500 text-lowercase'> {coreContext?.skill?.questions?.length || 0} </span>
                            }
