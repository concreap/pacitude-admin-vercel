...
export type ApiServiceType = 'default' | 'identity' | 'core' | 'genius' | 'resource';
...
export type PositionType = 'default' | 'top' | 'top-left' | 'top-right' | 'bottom' | 'bottom-left' | 'bottom-right' | 'left' | 'right'
